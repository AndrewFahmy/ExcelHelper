...
{
    public partial class UpdateExcel
    {
        ...
        public UpdateExcel(ILocalService localService, Window owner, CustomTabItem parentTab)
        {
            ...
            CbConnections.ItemsSource = localService.ConnectionsService.GetConnections();
        ...
        private void UpdateExcel_OnLoaded(object sender, RoutedEventArgs e)
        {
        ...
        private async void BtnUpdate_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(query))
            {
                ...
                var resultUpdate = await Task.Factory.StartNew(() =>
                {
                    ...
                    var result = dbservice.UpdateExcelService.Execute(model,
